...
- We do not run analytics, ad networks, or tracking SDKs in our apps.
- We do not have user accounts on our side. There is no Finnvek server that stores your data.
- The data your app creates lives on your device. If you uninstall the app, it goes with it.
- A few features, like AI assistance and connecting to Ravelry, need to talk to other companies' servers. When that happens, we say which company, why it happens, and link to their privacy policy.
...
You can reach us at [contact@finnvek.com](mailto:contact@finnvek.com).
...
- The Finnvek apps listed in the per-app details section below
...
- Crash reporting that sends data to third parties
...
### What we do, but only when needed
...
Email sent to [contact@finnvek.com](mailto:contact@finnvek.com) goes through Cloudflare Email Routing and is delivered to a Gmail inbox. We read and reply to it personally.
...
- Significant updates to our apps
- Occasional behind-the-scenes notes from the studio
...
- Tracking what you do on our websites

Every email includes an unsubscribe link. Unsubscribing removes you from future sends. If you also want your address deleted from MailerLite entirely, email [contact@finnvek.com](mailto:contact@finnvek.com) and we'll remove it.
...
The one exception is the newsletter mailing list in MailerLite. If you have subscribed and want your email address removed, unsubscribe via any newsletter or email [contact@finnvek.com](mailto:contact@finnvek.com) and we'll delete it.
...
- **Internet**: needed to talk to Ravelry, Firebase AI, and the Google Play Store. Without internet, the app still works for everything that does not depend on those services.
- **Camera**: used only when you choose to scan a yarn label or a printed pattern. We do not access the camera in the background.
- **Microphone**: used only when you turn on voice commands or start a Gemini Live voice session. We do not listen in the background.
...
- **Consent**: for AI features, microphone use, and camera use, which only run when you explicitly trigger them
- **Legitimate interest**: checking for app updates and basic operation of Google Play Services
